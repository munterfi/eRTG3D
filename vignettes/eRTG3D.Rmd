...
To carry out a CRS transformation, please use `transform.CRS.3d()`, which is based on the `st_transform()` from the `sf` package. Therefore is supports CRS transdormations in 3D.

```{r eval=FALSE}
WGS84 <- "+init=epsg:4326"
LV95 <- "+init=epsg:2056"
track <- transform.CRS.3d(track, fromCRS=WGS84, toCRS=LV95)
```
