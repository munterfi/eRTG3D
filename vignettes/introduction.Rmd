---
title: "eRTG3D: Introduction"
author: "Unterfinger Merlin"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{The basic functionality of the `eRTG3D` package}
...
## Visualize results
The resulting tracks can be plotted either in 2-D or in 3-D, using the `ggplot2` and `plotly` libraries. Additionally the densities of the track properties can be visualized.
...
```
<img src="figs/densities2d.png" alt="Drawing" style="width: 96.5%;"/>
...
```
<img src="figs/plot2d.png" alt="Drawing" style="width: 96.5%;"/>
